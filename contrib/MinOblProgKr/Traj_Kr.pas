...
begin
  ...
  VRF2 := (-A2/S2 * EXP(-R[2]/S2) + 1/sqr(R[2]) + 2*(ALF2 + ALF3)/power(R[2], 5)+6*C2/power(R[2], 7) -
             ...
             ALF1*(1/power(R[1], 4) + 1/power(R[3], 4)+(sqr(R[2])-sqr(R[1])-sqr(R[3])) /
                     power(R[1], 3)/power(R[3], 3))*
