...
//БШБНД ЙЮФДНИ МЮВЮКЭМНИ РНВЙХ ОНХЯЙЮ Б ТЮИК
var
  tf: textfile;
  fname: string;
begin
...
//БШБНД ЙЮФДНЦН ЖЕМРПЮ ЯХЛОКЕЙЯЮ Б ТЮИК
var
  tf: textfile;
  fname: string;
begin
...
//БШБНД ЙЮФДНИ БЕПЬХМШ ЯХЛОКЕЙЯЮ Б ТЮИК
var
  tf: textfile;
  fname: string;
begin
...
begin
  repeat
    ...
    savecenter;
  until 1/4 * (sqrt(sqr(sympl[1].emolec - center.emolec) + sqr(sympl[2].emolec - center.emolec) + sqr(sympl[3].emolec - center.emolec)+sqr(sympl[4].emolec - center.emolec))) <= eps1;
end;
...
begin
  ...
  begin
    repeat
      ...
      if (edit1.Text <> '10') and (edit2.Text <> '10') then delete(tname, 1, 10);
      if ((edit1.Text = '10') and (edit2.Text <> '10')) or ((edit1.Text <> '10') and (edit2.Text = '10')) then delete(tname, 1, 11);
      if (edit1.Text = '10') and (edit2.Text = '10') then delete(tname, 1, 12);
      try
        tt := strtoint(tname);
      except
...
begin
  ...
  if (checkbox1.Checked) and not(Checkbox2.Checked) and (checkbox6.Checked) then begin
    ...
    repeat
      ...
      t.eini := t.eini + 1; edit1.Text := floattostr(t.eini);
      t.erel := 1; edit2.Text := floattostr(t.erel);
